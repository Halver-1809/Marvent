...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td><a class="btn btn-warning btn-sm" id="" href="../views/editarProducto.php?id=' . $row['IdProducto'] . '">Editar</a></td>';
        $output['data'] .= "<td><a class='btn btn-danger btn-sm' href='../controllers/eliminarProd.php?id=" . $row['IdProducto'] . "'>Eliminar</a></td>";
        $output['data'] .= '</tr>';
        }
