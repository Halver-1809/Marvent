...
$information1= "SELECT * FROM proveedor";
$result=mysqli_query($conn,$information1);
...
<body>
    <header>
        <nav class="navbar navbar-expand-md navbar-light">
            <div class="container nav">
                ...
                <div class="col ">
                    <h1 class="text-cenetr">PROVEEDORES</h1>
    ...
    <nav class="container-fluid">
        <div class="row">
            ...
            <div class="col-xxl-9 col-xl-9 col-md-7 edit5 text-md-center">
                <!--boton de buscar-->
                <div class="uno">
                                ...
                                <div class="row py-4">
                                    <div class="col">
                                        <table class="table table-sm table-bordered table-striped">
                                            <thead>
                                                <th class="sort asc">IdProveedor</th>
                                                <th class="sort asc">ProvEmailPersonal</th>
                                                <th class="sort asc">ProvNombre</th>
                                                <th class="sort asc">ProvTelPersonal</th>
                                                <th class="sort asc">ProvDireccion</th>
                                                <th></th>
                                                <th></th>
                                            </thead>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-lg-center ingresar">
                                                <form action="../controllers/proveedores.php" method="POST">
                                                    ...
                                                    <input type="text" name="Email_Proveedor" required
                                                    ...
                                                    <input type="number" name="Telefono_Personal" required
                                                        placeholder="Telefono personal">
                                                    <p>Direccion</p>
                                                    <input type="text" name="Direccion_proveedor" required
                                                        placeholder="Direccion de la empresa">
                                            </div>
                                            <div class="modal-footer">
                                                <a href="providers.php"><button type="button" class="btn btn-secondary"
