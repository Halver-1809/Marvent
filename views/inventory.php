...
$information= "SELECT * FROM producto";
$result=mysqli_query($conn,$information);
    ...
    <section class="container-fluid">
        <div class="row">
                        ...
                        <main>
                            <div class="container py-4 text-center">
                                <div class="row g-4">
                                    ...
                                    <div class="col-auto">
                                        <button type="button" class="btn btn-dark agregar" data-bs-toggle="modal"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-lg-center ingresar">
                                                <form class="W-75 m-5" action="../controllers/inventario.php"
                                                    method="POST">
                                                    ...
                                                    <input type="text" name="MarcaProducto" required
                                                        placeholder="Marca">
                                                    <p>Fecha Expedicion del producto</p>
                                                    <input type="text" name="FechaProducto" required
                                                        placeholder="Año-Mes-Dia">
                                                    <p>Cantidad Del Producto</p>
                                                    <input type="number" name="CantidadProducto" required
            ...
            <footer class="row" id="row-pie">
                ...
                <div class="pie-bajo">
                    <p class="text-center"> &copy; 2023 Copyright <a href="#row-contacto">Generado por:
                            MARVENT</a> </p>
                </div>
            </footer>
        </div>
