...
<header>
    <nav class="navbar navbar-expand-md navbar-light">
        <div class="container nav">
            ...
            <div class="col ">
                <h1 class="text-cenetr">EDITAR PROVEEDOR</h1>
    ...
    <div class="row">
        ...
        <nav class="d-flex col-xxl-12 col-xl-12 col-md-12 edit5 ">
            ...
            <div class="modal-body text-lg-center ingresar">
                <form action="../controllers/editarProv.php" method="POST">
          ...
          ?>
                    ...
                    <input type="hidden" name="Id" value="<?php echo $row_filtro['IdProveedor']; ?>">
                    <input type="text" name="Email_Proveedor" required placeholder="email"
                        value="<?php echo $row_filtro['ProvEmailPersonal'] ?>">
                    <p>Nombre Del Proveedor</p>
                    <input type="text" name="Nombre_Proveedor" required placeholder="nombre"
                        value="<?php echo $row_filtro['ProvNombre'] ?>">
                    <p>Telefono Personal</p>
                    <input type="text" name="Telefono_Personal" required placeholder="telefono"
                        value="<?php echo $row_filtro['ProvTelPersonal'] ?>">
                    <p>Direccion</p>
                    <input type="text" name="Direccion_proveedor" required placeholder="direccion"
                        value="<?php echo $row_filtro['ProvDireccion'] ?>">
                    <div class="botones">
