...
$information2= "SELECT * FROM cliente";
$result=mysqli_query($conn,$information2);
session_start();
    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-light">
            <div class="container nav">
                ...
                <div class="col ">
                    <h1 class="text-cenetr">CLIENTES</h1>
            ...
            <div class="col-xxl-9 col-xl-9 col-md-7 edit5">
                ...
                <div class="uno">
                    <div class="text-md-center text-ms-start">
                                ...
                                <div class="row py-4">
                                    <div class="col">
                                        <table class="table table-s table-bordered table-striped">
                                            <thead>
                                                <th class="sort asc">IdCliente</th>
                                                <th class="sort asc">ClieCedula</th>
                                                <th class="sort asc">ClieNombre</th>
                                                <th class="sort asc">ClieTelPersonal</th>
                                                <th class="sort asc">ClieDireccion</th>
                                                <th class="sort asc">ClieEmailPersonal</th>
                                                <th></th>
                                                <th></th>
                                            </thead>
                        ...
                        <!--boton de agreagar productos-->
                        <div class="tres">
                            <div class="container-fluid text-center">

                                <!--<button type="button" class="agregar " data-bs-toggle="modal" data-bs-target="#exampleModal1">
                  <i class="bi bi-person-plus"></i> AGREGAR CREDITO
                  </button>-->
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title btn-success" id="exampleModalLabel">Agregar
                                                    Cliente</h5>
                                            ...
                                            <div class="modal-body text-lg-center ingresar">
                                                <form action="../controllers/cliente.php" method="POST">
                                                    ...
                                                    <input type="text" name="Nombre_Cliente" required
                                                        placeholder="Primero Nombre y Primer Apellido">
                                                    <p>Telefono Del Cliente</p>
                                                    <input type="number" name="Telefono_Cliente" required
                                                        placeholder="Telefono personal del cliente">
                                                    <p>Direccion Del Cliente</p>
                                                    <input type="text" name="Direccion_Cliente" required
                                                        placeholder="Direccion de el cliente">
                                                    <p>Email Personal Del Cliente</p>
                                                    <input type="text" name="Email_Cliente" required
                                                        placeholder="Email personal de el cliente">
                                            </div>
                                            <div class="modal-footer">
